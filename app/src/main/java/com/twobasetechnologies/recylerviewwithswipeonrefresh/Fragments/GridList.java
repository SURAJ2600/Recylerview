...
public class GridList extends Fragment implements OnLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                mAdapter = new FeeddataAdapter((MainActivity) getActivity(), counts, "grid");
        ...
        loaddata();
        mAdapter = new FeeddataAdapter(getActivity(), counts, "grid");
      ...
      /*  RecyclerView.LayoutManager mLayoutManager = new StaggeredGridLayoutManager(getActivity());
    ...
    public void onLoadMore(int Position) {
        ...
        h.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                imreceive_progressbars.setVisibility(View.GONE);
                recyclerView.scrollToPosition(counts.size());
